...
class FriendsAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FriendsAdapter.UserViewHolder {
    ...
    override fun onBindViewHolder(holder: FriendsAdapter.UserViewHolder, position: Int) {
